from PySide2.QtWidgets import QApplication, QLabel, QMainWindow, QSizePolicy, QWidget, QGridLayout, QPushButton, \
    QCheckBox, QSpinBox, QRadioButton, QDoubleSpinBox
import navigate
import blueprint
import placeholder
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        layoutInputs = {'placeholderLayout': {'spacePositionLayout': {}, 'stepLayout': {}},
                        'matchLayout': {'setPositionsLayout': {'axisLayout': {}, 'attributesLayout': {}}},
                        "explodeLayout": {}}
        ...
        #
        # self.updateAllPlaceholders = se lf.button("update all \n placeholders")
        # self.updateAllPlaceholders.clicked.connect(
        #     lambda: placeholder.update(pm.ls(constants.placeholderGroup)[0].listRelatives(s=False)))
        #
        ...
        # self.resetAllPlaceholders.clicked.connect(
        #     lambda: placeholder.reset(pm.ls(constants.placeholderGroup)[0].listRelatives(s=False)))
